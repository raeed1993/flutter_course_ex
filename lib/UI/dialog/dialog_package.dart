...
class DialogPackageScreen extends StatefulWidget {
  const DialogPackageScreen({
    Key? key,
  }) : super(key: key);

  @override
  _DialogPackageScreenState createState() => _DialogPackageScreenState();
}

class _DialogPackageScreenState extends State<DialogPackageScreen> {
  @override
