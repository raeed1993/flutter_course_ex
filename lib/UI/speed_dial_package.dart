...
class SpeedAppDial extends StatefulWidget {
  const SpeedAppDial({Key? key}) : super(key: key);
  @override
  _SpeedAppDialState createState() => _SpeedAppDialState();
}

class _SpeedAppDialState extends State<SpeedAppDial> {
