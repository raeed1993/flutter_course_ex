    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        items:[
          ...
          BottomNavigationBarItem(icon: Icon(Icons.insert_page_break), label: "Page2")
        ],
        onTap: (val)=>setState(() {
          currentPage= val;
        },
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        GridView.builder(  // GridView Eaxmple
           key: PageStorageKey('asf'),
          itemCount: 200,
          itemBuilder: (context, index){
            return Card(
              color: Colors.primaries[Random().nextInt(Colors.primaries.length)].shade100, //Colors.purple.shade200,
